-- What Katie Seas: allow divider line blocks in existing post_blocks table
-- Run this if docs/supabase-posts.sql was already run before divider blocks existed.
