-- What Katie Seas: allow YouTube video blocks in existing post_blocks table
-- Run this if docs/supabase-posts.sql was already run before youtube blocks existed.
